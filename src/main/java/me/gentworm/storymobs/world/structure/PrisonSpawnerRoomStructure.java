...
public class PrisonSpawnerRoomStructure extends StructureFeature<NoneFeatureConfiguration> {
	...
	public PrisonSpawnerRoomStructure(Codec<NoneFeatureConfiguration> p_i51440_1_) {
		super(p_i51440_1_);
	}
	...
	public StructureStartFactory<NoneFeatureConfiguration> getStartFactory() {
		return PrisonSpawnerRoomStructure.Start::new;
	}
