...
public class ConfiguredStructures {
	public static StructureFeature<?, ?> CONFIGURED_PRISON = StoryMobsStructures.PRISON.get()
			.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG);
	public static StructureFeature<?, ?> CONFIGURED_EVERSOURCE_STRUCTURE = StoryMobsStructures.EVERSOURCE_STRUCTURE
	...
	public static void registerConfiguredStructures() {
		...
		FlatGenerationSettings.STRUCTURES.put(StoryMobsStructures.EVERSOURCE_STRUCTURE.get(),
				CONFIGURED_EVERSOURCE_STRUCTURE);
