...
public class GiantGhastRenderer extends MobRenderer<GiantGhastEntity, GiantGhastModel> {
	...
	public GiantGhastRenderer(EntityRendererManager p_i46174_1_) {
		super(p_i46174_1_, new GiantGhastModel(), 1.5F);
	}

	@Override
	public ResourceLocation getEntityTexture(GiantGhastEntity p_110775_1_) {
		return GIANT_GHAST_TEXTURES;
	}

	@Override
	@SuppressWarnings("unused")
	protected void preRenderCallback(GiantGhastEntity p_225620_1_, MatrixStack p_225620_2_, float p_225620_3_) {
		float lvt_4_1_ = 1.0F;
		float lvt_5_1_ = 4.5F;
		float lvt_6_1_ = 4.5F;
