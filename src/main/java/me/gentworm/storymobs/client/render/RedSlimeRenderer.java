...
public class RedSlimeRenderer extends MobRenderer<RedSlimeEntity, RedSlimeModel<RedSlimeEntity>> {
	...
	public RedSlimeRenderer(EntityRendererManager p_i47193_1_) {
		super(p_i47193_1_, new RedSlimeModel(16), 0.25F);
		addLayer((LayerRenderer<RedSlimeEntity, RedSlimeModel<RedSlimeEntity>>) new RedSlimeGlowLayer(this));
		addLayer((LayerRenderer<RedSlimeEntity, RedSlimeModel<RedSlimeEntity>>) new SlimeGelLayer(this));
	}

	public void render(RedSlimeEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_,
			IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
		this.shadowSize = 0.25F * p_225623_1_.getSlimeSize();
		super.render(p_225623_1_, p_225623_2_, p_225623_3_, p_225623_4_, p_225623_5_, p_225623_6_);
	}

	protected void preRenderCallback(RedSlimeEntity p_225620_1_, MatrixStack p_225620_2_, float p_225620_3_) {
		...
		float lvt_6_1_ = MathHelper.lerp(p_225620_3_, p_225620_1_.prevSquishFactor, p_225620_1_.squishFactor)
				/ (lvt_5_1_ * 0.5F + 1.0F);
		float lvt_7_1_ = 1.0F / (lvt_6_1_ + 1.0F);
		p_225620_2_.scale(lvt_7_1_ * lvt_5_1_, 1.0F / lvt_7_1_ * lvt_5_1_, lvt_7_1_ * lvt_5_1_);
	}

	public ResourceLocation getEntityTexture(RedSlimeEntity p_110775_1_) {
