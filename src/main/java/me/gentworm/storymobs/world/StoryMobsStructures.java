...
public class StoryMobsStructures {
	...
	public static final DeferredRegister<Structure<?>> REGISTER = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, StoryMobs.MODID);
	...
	public static final RegistryObject<Structure<NoFeatureConfig>> EVERSOURCE_STRUCTURE = REGISTER.register("eversource_structure", () -> (new EversourceStructure(NoFeatureConfig.field_236558_a_)));
	...
	public static void setupStructures() {
		...
		setupMapSpacingAndLand(EVERSOURCE_STRUCTURE.get(), new StructureSeparationSettings(300, 275, 4857626), false);
	}
	...
	public static void registerStructurePieces() {
		...
		Registry.register(Registry.STRUCTURE_PIECE, new ResourceLocation(StoryMobs.MODID, "eversource_structure"), EVERSOURCE_PIECE_TYPE);
	}
}